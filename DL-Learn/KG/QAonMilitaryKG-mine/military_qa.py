...
class MilitaryGraph:
    ...
    def __init__(self):
        ...
        #     '<=': ['不高于', '不大于', '不长于', '不高过', '不大过', '不长过', '不多于', '不远于', '不远过'],
        #     '>=': ['不低于', '不小于', '不短于', '不低过', '不短过', '不少于', '不近于', '不近过', '达到'],
        #     '=': ['等于', '差不多'],
        #     '!=': ['不等于', '不是']}
        ...
        self.mosts = {
            'max': ['最大', '最远', '最长', '最高', '最久', '最快', '最多', '最强'],
            'min': ['最小', '最短', '最近', '最低', '最矮', '最慢', '最少', '最弱'],
        }
    ...
    def add_jieba(self, wds, tag):
        # 这里wds是字典，但这种方式只对key进行遍历（惊了）
        for wd in wds:
            # 配置jieba，以  （单词，词性）  这种方式加入配置
    ...
    def question_parser(self, question):
        ...
        # 根据之前配置的jieba分词词典，利用pseg对问句分词，遍历 词和词性
        # {'n_attrs': [], 'n_times': [], 'n_bigs': [], 'n_smalls': [], 'n_countries': [], 'n_compares': [], 'n_mosts': [], 'n_units': [], 'n_weapons': [], 'pattern': []}
    ...
    def search_answer(self, parser_dict):
        ...
        # 多实体多属性
            ...
            ['n_weapon', 'n_weapon', 'n_weapon', 'n_attr', 'n_attr', 'n_attr', 'n_attr', 'n_attr'],
            ...
            ['n_weapon', 'n_weapon', 'n_weapon', 'n_weapon', 'n_attr', 'n_attr', 'n_attr', 'n_attr'],
            ['n_weapon', 'n_weapon', 'n_weapon', 'n_weapon', 'n_attr', 'n_attr', 'n_attr', 'n_attr', 'n_attr'],
            ['n_weapon', 'n_weapon', 'n_weapon', 'n_weapon', 'n_attr', 'n_attr', 'n_attr', 'n_attr', 'n_attr',
             'n_attr'],
...
if __name__ == '__main__':
    ...
    # 处理些dict
    # object = MilitaryGraph()
    # print(object.countries)
    # with open('files/most.txt', 'a+') as f:
    #     for key, value in object.mosts.items():
